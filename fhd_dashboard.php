...
<h3><i class="fa fa-tachometer fa-lg"></i> AdminCop Dashboard</h3>
<hr>
<?php
...
//only show Cops for the user if not admin.
switch ($user_level) {
    case 0:
        $queryadd = "";
        break;
...
<p><a href="fhd_calls.php"<?php echo $button_style;?>><i class="fa fa-folder-open-o pull-left"></i> Pending Cops: <?php echo $opentickets; ?></a></p>
<p><a href="fhd_search.php?call_status=&search=1&recent=1"<?php echo $button_style;?>><i class="fa fa-folder-o pull-left"></i> Total Cops: <?php echo $db->get_var("select count(call_id) from site_calls where call_status < 2  $queryadd;")?></a></p>
